...
import com.files.entity.Customer;
...
public class CustomerDao 
{
	...
	public CustomerDao() 
	{
		ssr= new StandardServiceRegistryBuilder().configure("com\\files\\resourcesxml\\hibernate.cfg.xml").build();
	...
	public void registerCustomer()
	{
		...
		System.out.println("3. Register Customer Only");
