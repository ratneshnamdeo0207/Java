...
import com.files.entity.BeachDestination;
import com.files.entity.MountainDestination;
import com.files.entity.TravelInformation;
...
public class TravelDao 
{
		...
		public TravelDao() 
		{
			ssr= new StandardServiceRegistryBuilder().configure("com\\files\\resources\\hibernate.cfg.xml").build();
